...
<div class="foot"><span>%s</span><span class="center">ash 0.1.11</span><span class="right">%s</span></div>
</body>
</html>
|}
...
<ul>%s</ul>
<div class="foot"><span>ash(1)</span><span class="center">ash 0.1.11</span><span class="right">ash(1)</span></div>
</body>
</html>
|}
    (normalize_base_href base_href)
